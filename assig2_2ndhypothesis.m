...
clear all
close all
% 1st hypothesis using the first 4 features and logistic regression function with error E
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% cross validation 20%
xx=T{m_60+1:m_60+m_20,1:4};
xx0=T{m_60+1:m_60+m_20,5:13};
...
p=a-(m_60+m_20);
xxx=T{m_60+m_20+1:end,1:4};
xxx0=T{m_60+m_20+1:end,5:13};
